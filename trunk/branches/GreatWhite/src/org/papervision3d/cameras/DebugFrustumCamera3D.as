package org.papervision3d.cameras 
{
	...
	/**
	 * <p>
	 * DebugFrustumCamera3D serves as a tool to allow you control
	 ...
	 */
	public class DebugFrustumCamera3D extends FrustumCamera3D 
	{
		public static const TYPE:String = "DEBUGFRUSTRUMCAMERA3D";
		/** @private */
		 ...
		 */
		public function DebugFrustumCamera3D(viewport3D:Viewport3D, fov:Number = 90, near:Number = 10, far:Number = 1000) 
		{
			super(viewport3D, fov, near, far);
			displayProperties();
			checkStageReady();	
		}
		...
		protected function onEnterFrameHandler(event:Event):void 
		{
			...
			nearText.text = 'near:' + int(near);
			farText.text = 'far:' + int(far);
		}
